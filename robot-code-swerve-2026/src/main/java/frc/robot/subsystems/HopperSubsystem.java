...
public class HopperSubsystem extends SubsystemBase {
  ...
  double HopperExtentionTarget;
  double HopperRetractionTarget;
  ...
  public void HopperExtend() {
    HopperMotor.setVoltage(
      HopperExtentionPID.calculate(HopperExtentionActual, HopperExtentionActual)
    );
  }
  ...
  public void HopperRetract() {
    HopperMotor.setVoltage(
      HopperRetractionPID.calculate(HopperExtentionActual, HopperRetractionTarget)
    );
  }
